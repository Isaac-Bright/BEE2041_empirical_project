...
* *Team averages” –  is data from many different pages so is scraped using code/scraping.py and is not committed. Running ‘make’ creates a csv of this raw data (data/raw_team_stats.csv).
...
Requirements.txt has only the names of the python packages to prevent issues on newer systems but exact versions are as follows:
* cloudscraper==1.2.71
* numpy==2.4.4
* matplotlib==3.10.9
* pandas==3.0.2
